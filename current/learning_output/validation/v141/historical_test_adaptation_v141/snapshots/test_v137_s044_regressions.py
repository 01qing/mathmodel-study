...
ck('version compatible',st['current_version'] in {'1.37.0','1.38.0'})
ck('latest compatible',st['latest_completed_paper'] in {'S044','S045'})
ck('R2 latest compatible',st['reproduction_level_latest'] in {'S044:R2','S045:R2'})
req=[
