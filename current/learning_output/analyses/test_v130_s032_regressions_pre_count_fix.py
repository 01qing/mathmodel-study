...
for x in ['Q1_METRIC_TABLE','Q2_EXTREME_FIT','Q3_JRC_RANGE_CONFLICT','Q3_SCALE_FACTOR_INJECTION','Q4_SCORE_COMPARISON','Q4_ENTROPY_IMPLEMENTATIONS','Q4_GA_CROSSOVER','Q4_DDENSITY_DIRECTION']:
...
for x in ['Q1_SPLIT_LOADER_MISSING','Q2_ROBUST_FIT_NOT_IMPLEMENTED','Q3_HEADLINE_LOG_ATTENTION_ABSENT','Q3_PER_IMAGE_SCALE_FACTOR','Q4_DENSITY_ENTROPY_BUG','Q4_PPIGA_CODE_ABSENT']:
...
# exact count for stable specialist suite
assert len(checks)==62, len(checks)
