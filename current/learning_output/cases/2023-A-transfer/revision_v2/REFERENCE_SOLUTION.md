> 案例修订 v2：前文保留学习前冻结解答，其中“未读同题解答”等表述仅指冻结时点。当前已读第一篇同题论文；新增学习与验证见文末。图片链接已调整到原文件位置。
...
![数值模型与事件模型比较](D:/softdown/codex/mathmodel-study/current/learning_output/cases/2023-A-transfer/deliverables/model_comparison.png)

![隐藏节点参数和三 BSS 公平性](D:/softdown/codex/mathmodel-study/current/learning_output/cases/2023-A-transfer/deliverables/hidden_and_fairness.png)
