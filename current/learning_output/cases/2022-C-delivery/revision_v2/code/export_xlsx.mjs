...
const inspect=await wb.inspect({kind:'table',range:'Sheet1!A1:T15',include:'values,formulas',tableMaxRows:15,tableMaxCols:20});
await fs.writeFile(path.join(root,'deliverables',key+'_inspect.ndjson'),inspect.ndjson);
