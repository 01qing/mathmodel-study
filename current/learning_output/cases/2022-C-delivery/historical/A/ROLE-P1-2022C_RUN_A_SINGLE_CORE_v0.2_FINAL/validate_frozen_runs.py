...
def audit_one(key,r,q,input_data):
    ...
    for name,evs,dmap in [('receiving',rf+rr,recv_d),('sending',so+sr,send_d)]:
        ready=-10**9
        for e in evs:
            s,kind,c,l,d=e
...
# Workbook portability evidence was already captured with artifact_tool before this standalone validation pass.
workbook_checks=[
 {'key':'result11','portable_recalc_status':'NOT_VERIFIED','artifact_tool_observation':'Sheet1 B2 evaluated as #VALUE!','formula_family':'LET + XLOOKUP dynamic array'},
 {'key':'result12','portable_recalc_status':'NOT_VERIFIED','artifact_tool_observation':'Sheet1 B2 evaluated as #VALUE!','formula_family':'LET + XLOOKUP dynamic array'},
 {'key':'result21','portable_recalc_status':'NOT_VERIFIED','artifact_tool_observation':'Sheet1 B2 evaluated as #VALUE!','formula_family':'LET + XLOOKUP dynamic array'},
 {'key':'result22','portable_recalc_status':'NOT_VERIFIED','artifact_tool_observation':'Sheet1 B2 evaluated as #VALUE!','formula_family':'LET + XLOOKUP dynamic array'}
]
