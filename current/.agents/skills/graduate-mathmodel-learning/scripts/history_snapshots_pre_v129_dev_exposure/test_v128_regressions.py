...
ok('state v128',st['current_version']=='1.28.0')
ok('state S028',st['latest_completed_paper']=='S028')
ok('state S028 R2',st['reproduction_level_latest']=='S028:R2')
nexttxt=(R/'learning_output/context/next_learning.md').read_text(encoding='utf-8')
ok('next is Dev protocol','S029-S031' in nexttxt and 'Dev' in nexttxt)
ok('test remains frozen','Test' in nexttxt and 'strictly' in nexttxt)
