...
ck('version compatible',st['current_version'] in {'1.35.0','1.36.0','1.37.0'}); ck('latest progressed',st['latest_completed_paper'] in {'S042','S043','S044'}); ck('historical R2 preserved',P['S042'].get('reproduction_level')=='R2')
...
nexttxt=(ROOT/'learning_output/context/next_learning.md').read_text(encoding='utf-8'); ck('next legal progression',('S043 / 2025-F' in nexttxt) or ('S044 / 2025-F' in nexttxt) or ('S045 / 2025-F' in nexttxt)); ck('not due','NOT_DUE' in nexttxt and 'S045' in nexttxt); ck('test frozen','Test' in nexttxt and 'frozen' in nexttxt)
