...
ck('version',st['current_version']=='1.36.0'); ck('latest',st['latest_completed_paper']=='S043'); ck('R1 latest',st['reproduction_level_latest']=='S043:R1')
...
mp=load('knowledge_base/cross_paper_maps/2025-F-S042-S045.json'); ck('map two reviewed',mp['status']=='PROVISIONAL_TWO_OF_FOUR_TRAIN_PAPERS_REVIEWED'); ck('reviewed S042 S043',mp['papers_reviewed']==['S042','S043']); ck('pending two',mp['papers_pending']==['S044','S045'])
...
nexttxt=(ROOT/'learning_output/context/next_learning.md').read_text(encoding='utf-8'); ck('next S044','S044 / 2025-F' in nexttxt); ck('not due','due only after S045' in nexttxt); ck('test frozen text','Test' in nexttxt and 'frozen' in nexttxt)
