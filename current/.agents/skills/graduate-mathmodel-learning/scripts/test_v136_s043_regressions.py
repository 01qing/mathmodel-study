...
ck('version',tuple(map(int,st['current_version'].split('.')[:2])) >= (1,36)); ck('latest',st['latest_completed_paper'] in {'S043','S044','S045','S013','S014','S015','S016'}); ck('R1/latest lifecycle',st['reproduction_level_latest'] in {'S043:R1','S044:R2','S045:R2','S013:R2','S014:R2','S015:R2','S016:R2'})
