...
# ADAPTED v1.29+: S029 reviewed under frozen Dev protocol; reserve remains unread.
...
ok('state preserves S027-or-later',tuple(map(int,state['current_version'].split('.'))) >= (1,27,0) and (R/'knowledge_base/paper_reviews/2025-A-S027-core.json').exists())
