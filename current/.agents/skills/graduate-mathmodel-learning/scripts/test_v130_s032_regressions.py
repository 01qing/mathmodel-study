...
# Historical S032 contract remains valid while later legitimate Train reviews may advance.
ck('post-S032 later Train progression legal', P['S034']['split']=='train' and P['S035']['split']=='train' and P['S036']['split']=='train' and P['S034'].get('reviewed_pages',[]) in [[],list(range(1,69))] and P['S035'].get('reviewed_pages',[]) in [[],list(range(1,92))] and P['S036'].get('reviewed_pages',[]) in [[],list(range(1,77))])
