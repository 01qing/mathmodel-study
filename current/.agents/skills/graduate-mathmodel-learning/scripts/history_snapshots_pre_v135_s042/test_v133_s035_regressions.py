...
ck("version",(ROOT/'learning_output/context/learning_state.json').exists() and load('learning_output/context/learning_state.json')['current_version']=='1.33.0')
...
ck('period',abs(math.pi*30-94.25)<0.01); ck('reviewed',P['S035']['reviewed_pages']==list(range(1,92))); ck('S036 unread',P['S036']['reviewed_pages']==[])
...
mp=load('knowledge_base/cross_paper_maps/2025-C-S032-S036.json'); ck('map4',mp['status']=='PROVISIONAL_AFTER_FOUR_TRAIN_PAPERS'); ck('pending',mp['papers_pending']==['S036'])
