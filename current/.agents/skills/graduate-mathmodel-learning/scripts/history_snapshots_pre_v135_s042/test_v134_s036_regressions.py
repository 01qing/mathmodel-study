...
st=load('learning_output/context/learning_state.json'); ck('version',st['current_version']=='1.34.0'); ck('latest',st['latest_completed_paper']=='S036')
...
nexttxt=(ROOT/'learning_output/context/next_learning.md').read_text(); ck('next S042','S042 / 2025-F' in nexttxt); ck('test frozen','Test' in nexttxt and 'frozen' in nexttxt)
