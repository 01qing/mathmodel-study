...
ck('map future pending excludes completed S034',mp['papers_pending']==['S035','S036'])
ck('map remains provisional through S034',mp['status'] in ['PROVISIONAL_AFTER_TWO_TRAIN_PAPERS','PROVISIONAL_AFTER_THREE_TRAIN_PAPERS'])
...
ck('retriever group remains provisional',cg['2025-C']['status'] in ['PROVISIONAL_2_OF_5_TRAIN_PAPERS','PROVISIONAL_3_OF_5_TRAIN_PAPERS'])
