...
nexttxt=(ROOT/'learning_output/context/next_learning.md').read_text(); ck('next progression beyond 2025-C',('2025-F' in nexttxt) or ('2024-D' in nexttxt) or ('clean unseen' in nexttxt.lower())); ck('test frozen','Test' in nexttxt and 'frozen' in nexttxt)
